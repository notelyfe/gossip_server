...
const verificationMail = async (receiver, verificationToken) => {
    ...
    try {
        ...
        await transporter.sendMail({
            ...
            html: `<p> Thankyou for registration. Please click on the <a href="${clientBaseUrl}/verify?verificationToken=${verificationToken}">Verify Email</a> link to continue</p>
            <br />
